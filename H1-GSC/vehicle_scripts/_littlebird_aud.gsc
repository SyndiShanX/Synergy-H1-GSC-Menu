...
littlebird_sentinel_constructor() {
  ...
  var_56 = 500;
  var_57 = 6.0;
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_near_dist2vol", [
    [var_7, 1],
    [var_8, 0]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_far_dist2vol", [
    [var_13, 0],
    [var_14, 1],
    [var_15, 1]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_near_pch2vol", [
    [var_20, 0.2],
    [var_21, 1.0],
    [var_22, 0.2]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_far_pch2vol", [
    [var_20, 0.2],
    [var_21, 1.0],
    [var_22, 0.2]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_pitch_pch2vol", [
    [var_20, 1],
    [var_21, 0],
    [var_22, 1]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_live_dist2vol", [
    [var_23, 1],
    [var_24, 0]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_dist_far_dist2vol", [
    [var_32, 0.0],
    [var_33 * 0.333, 0.333],
    [var_33, 0]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_live1_accel2pch", [
    [var_38, 0.9],
    [var_39, 1.1]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_live1_accel2vol", [
    [var_38, 0],
    [var_39, 1]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_live1_dst2vol", [
    [var_41, var_44],
    [var_42, var_43]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_flyby_vel2vol", [
    [var_3, var_50],
    [var_6 * 0.25, var_51 * 0.5],
    [var_5, var_51]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_flyby_vel2pch", [
    [var_3, var_52],
    [var_5, var_53]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_dplr2pch", [
    [0.0, 0.0],
    [2.0, 2.0]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_dplr2vol", [
    [var_29, var_27],
    [var_30, var_26],
    [var_31, var_27]
  ]);
  soundscripts\_audio_vehicle_manager::avm_add_envelope("lbs_flyby_duck_envelope", [
    [0.0, 1.0],
    [0.4, 0.7],
    [0.6, 0.5],
    [0.8, 0.7],
